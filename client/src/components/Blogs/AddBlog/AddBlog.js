...
const AddBlog = () => {
  ...
  const PostBlog = async (e) => {
    ...
    try {
      ...
      if (blogExist.status===200 && blogExist.msg === "Yes") {
        ...
        try {
          ...
          showAlert("Problem with uploading image, try again later");
      ...
      showAlert("Problem with adding blog at server, try again later");
      navigate('/blogs');
    }
